...
const screenshotData = {
  ...
  details: {
    title: 'আবেদনের বিস্তারিত ও সাড়া দান (Request Details)',
    badge: 'আবেদন বিবরণ • 04',
    image: './assets/images/screen-details.jpg',
    alt: 'Astha Blood Request Details Screen',
    desc: 'নির্দিষ্ট কোনো জরুরি রক্তের আবেদনে ক্লিক করলে রোগীর বিস্তারিত তথ্য, হাসপাতালের সঠিক অবস্থান এবং সরাসরি সাড়া দেওয়ার ("Respond to Donate") সুবিধা পাওয়া যায়।',
    bullets: [
      { title: 'জরুরি রক্তের কার্ড', text: 'রোগীর নাম, প্রয়োজনীয় ব্যাগের সংখ্যা এবং জরুরি স্ট্যাটাস (Critical / Active)।' },
      { title: 'হাসপাতালের সঠিক ঠিকানা', text: 'হাসপাতাল ও এলাকার স্পষ্ট বিবরণ যেন দ্রুত পৌঁছানো সম্ভব হয়।' },
      { title: 'সরাসরি রক্তদানের অঙ্গীকার', text: '"Respond to Donate" বাটন চেপে সরাসরি রোগীকে সাহায্য করার দ্রুত পদক্ষেপ গ্রহণ।' }
    ]
  },
  alerts: {
    title: 'জরুরি নোটিফিকেশন (Real-time Alerts)',
    badge: 'নোটিফিকেশন ফিড • 05',
  ...
  profile: {
    title: 'রক্তদাতার প্রোফাইল ও স্ট্যাটাস (User Profile)',
    badge: 'প্রোফাইল সেটিংস • 06',
    image: './assets/images/screen-profile.jpg',
    alt: 'Astha User Profile Screen',
    desc: 'ব্যক্তিগত তথ্য, ঠিকানা, রক্তের গ্রুপ এবং রক্তদানের প্রাপ্যতা সুইচ ("রক্ত দিতে প্রস্তুত") এক জায়গায় সহজে নিয়ন্ত্রণ করুন।',
    bullets: [
      { title: 'প্রাপ্যতা নিয়ন্ত্রণ সুইচ', text: '"রক্ত দিতে প্রস্তুত" টগল অন/অফ করে প্রাপ্যতা নিয়ন্ত্রণ করার পূর্ণ স্বাধীনতা।' },
      { title: 'ঠিকানা ও যোগাযোগ বিবরণ', text: 'বিভাগ, জেলা, উপজেলা এবং এলাকা অনুযায়ী নির্ভুল তথ্য সংরক্ষণ।' },
      { title: 'স্বেচ্ছাসেবী রক্তদাতা মর্যাদা', text: 'কমিউনিটিতে একজন সক্রিয় রক্তদাতা হিসেবে স্বীকৃতি ও রেকর্ড।' }
    ]
  }
};
